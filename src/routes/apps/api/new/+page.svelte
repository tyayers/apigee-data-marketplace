      ...
      <div class="right_panel_content">
          ...
          <div class="right_content">
            ...
            <div class="input_field_panel">
              <input class="input_field" type="text" id="name" required value={newName} autocomplete="off" title="none" />
            ...
            <div class="input_field_panel">
              <input class="input_field" type="text" id="description" required value={newName} autocomplete="off" title="none" />
            ...
            <div class="controls">
              <button class="rounded_button_filled">Create</button>
