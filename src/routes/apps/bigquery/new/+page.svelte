<script lang="ts">
  ...
  function submit() {
    appService.CreateHubSubscription(project, datasetName, product).then((result) => {
      goto("/apps/bigquery");
    });
  }
      ...
      <div class="right_panel_content">
          ...
          <div class="right_content">
            ...
            <div class="right_content_tip">
              ...
              you can you can subscribe at the <a href="#" style="color: var(--primary-color)" target="_blank">Analytics Hub product page<svg class="right_content_tip_learnmore" width="18" height="18" aria-hidden="true"><path fill-rule="evenodd" d="M13.85 5H14V4h-4v1h2.15l-5.36 5.364.848.848L13 5.85V8h1V4h-1v.15l.15-.15.85.85-.15.15zM8 4H4.995A1 1 0 004 4.995v8.01a1 1 0 00.995.995h8.01a1 1 0 00.995-.995V10h-1v3H5V5h3V4z"></path></svg></a>
